package com.inihood.colorfultoast;
...
public class ColorfulToast extends LinearLayout {
    ...
    public static ColorfulToast makeText(@NonNull Context context, String text, int length, @StyleRes int style) {
        return new ColorfulToast(context, text, length, style);
    }

    public static ColorfulToast makeText(@NonNull Context context, String text, @StyleRes int style) {
        return new ColorfulToast(context, text, Toast.LENGTH_SHORT, style);
    }

    private ColorfulToast(@NonNull Context context, String text, int length, @StyleRes int style) {
        super(context);
        this.text = text;
        this.length = length;
        this.style = style;
    ...
    private void inflateToastLayout() {
        View v = inflate(getContext(), R.layout.colorful_toast_layout, null);
    ...
    public static class Builder {
        ...
        public Builder setIconStart(@DrawableRes int iconStart) {
            this.iconStart = iconStart;
            return this;
        }

        public Builder setIconEnd(@DrawableRes int iconEnd) {
         ...
         */
        public Builder setToastPosition(int gravity) {
        ...
        public void show() {
            ColorfulToast toast = new ColorfulToast(this);
            toast.show();
        }
    }
}
